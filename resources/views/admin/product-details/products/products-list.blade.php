                ...
                <table class="table table-centered table-nowrap mb-0 rounded" id="table_id">
                    ...
                    @foreach($products as $key=>$value)
                        <tr>
                            ...
                            <td class="border-0">
                                <a href="{{route('admin_products_edit').'/'.$value->id}}" class="text-secondary mr-3"><i class="fas fa-edit"></i>Edit</a>
                                <span class="text-primary"> |  </span>
                                <a href="{{route('admin_products_delete').'/'.$value->id}}" class="text-danger ml-3"><i class="far fa-trash-alt"></i>Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    <!-- End of Item -->
